...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1700, 960)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(210, 10, 557, 251))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(790, 10, 471, 251))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 350, 850, 581))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(900, 310, 781, 581))
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 10, 181, 301))
        ...
        self.param_b = QtWidgets.QLineEdit(self.gridLayoutWidget_2)
        self.param_b.setObjectName("param_b")
        self.gridLayout_2.addWidget(self.param_b, 6, 0, 1, 1)
        ...
        self.param_c = QtWidgets.QLineEdit(self.gridLayoutWidget_2)
        self.param_c.setObjectName("param_c")
        self.gridLayout_2.addWidget(self.param_c, 8, 0, 1, 1)
        ...
        # self.tabs.setGeometry(QtCore.QRect(10, 320, 511, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Контроль лок. погреш-ти(ε):"))
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "Основная"))
        self.comboBox.setItemText(1, _translate("MainWindow", "Тестовая"))
        self.label_3.setText(_translate("MainWindow", "Точ-ть выхода на гран.(ε гр):"))
        self.label_50.setText(_translate("MainWindow", "Начальное значение U(x0)=u0:"))
        ...
        self.label_7.setText(_translate("MainWindow", "х0, u0, Т, h0, ε, ε гр"))
        self.label_9.setText(_translate("MainWindow", "Nmax, ε min(ниж. грн. контроля погрешности), n, b-xn"))
        ...
        self.label_17.setText(_translate("MainWindow", "Параметр a2:"))
        self.param_b.setText(_translate("MainWindow", "2"))
        self.label_16.setText(_translate("MainWindow", "Параметр а1:"))
        self.param_a.setText(_translate("MainWindow", "1"))
        self.label_15.setText(_translate("MainWindow", "Задача Коши:"))
        self.param_c.setText(_translate("MainWindow", "3"))
        self.label_18.setText(_translate("MainWindow", "Параметр m:"))
